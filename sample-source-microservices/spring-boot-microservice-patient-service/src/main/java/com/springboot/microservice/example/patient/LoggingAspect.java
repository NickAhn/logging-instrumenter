...
public class LoggingAspect {
	...
	static String localDBPath = 
			"/home/nickel/Documents/logging-microservices-master/sample-source-microservices/spring-boot-microservice-patient-service/src/main/resources/local-db.txt";
	static String remoteDBPath =
			"/home/nickel/Documents/logging-microservices-master/sample-source-microservices/spring-boot-microservice-patient-service/src/main/resources/remote-db.txt";
	static String logDBPath = 
			"/home/nickel/Documents/logging-microservices-master/sample-source-microservices/spring-boot-microservice-patient-service/src/main/resources/log-db.txt";
...
ec.addFact("assert((lg(T0,T1,[U,P]) :- (T0, patient-service, \"com.springboot.microservice.example.patient.PatientController.getPatientMedHistByName\", [U, P]), (T1, authorization-service, \"com.springboot.microservice.example.authorization.AuthorizationController.breakTheGlass\", [U]), (T1, T0), (U, user)))");
