...
public class LoggingAspect {
	...
	//trigger aspects
	@Before("execution (* com.springboot.microservice.example.patient.PatientController.getAllPatients(..))")
	public void beforeT0(JoinPoint joinPoint) throws Throwable	{
	...
	private void addLoggingSpec( ) {
		...
		ec.addFact("assert((loggedfunccall(T0, patient-service, \"com.springboot.microservice.example.patient.PatientController.getPatientMedHistByName\", [U, P]) :- funccall(T0, patient-service, \"com.springboot.microservice.example.patient.PatientController.getPatientMedHistByName\", [U, P]), funccall(T1, authorization-service, \"com.springboot.microservice.example.authorization.AuthorizationController.breakTheGlass\", [U]), <(T1, T0), funccall(T2, patient-service, \"com.springboot.microservice.example.patient.PatientController.getAllPatients\", [U]), <(T2, T0), funccall(T3, authorization-service, \"com.springboot.microservice.example.authorization.AuthorizationController.getBTGUsers\", []), <(T3, T0), ==(U, user)))");
